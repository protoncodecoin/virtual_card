...
class ContactModel {
  ...
  @override
  String toString() {
    return 'ContactModel(id: $id, name: $name, mobile: $mobile, address: $address, company: $company, designation: $designation, website: $website, image: $image, email: $email, favorite: $favorite)';
  }
}
